...
export default function ProductDetails() {
  ...
  return (
    <div className="bg-white min-h-screen pb-24 lg:pb-10 pt-20 md:pt-24 selection:bg-black selection:text-white">
      {/* 🧭 Breadcrumbs */}
          ...
          <div className="w-full lg:w-[40%] xl:w-[35%] lg:sticky lg:top-24">
            ...
            <div className="border border-zinc-200 rounded-md p-4 flex gap-3 text-zinc-600 mb-8 bg-zinc-50/50">
              ...
              <p className="text-xs leading-relaxed font-medium">
                This product is eligible for return or exchange under our 7-day
